...
class Demo_actionAction{
    ...
    actionlib::SimpleActionServer<crudebot_test_pkg::Demo_actionAction> as;
    // create messages that are used to publish feedback/result

    crudebot_test_pkg::Demo_actionFeedback feedback;
    crudebot_test_pkg::Demo_actionResult result;
    ...
    public:
        ...
        void executeCB(const crudebot_test_pkg::Demo_actionGoalConstPtr &goal){
